-- CreateEnum
CREATE TYPE "public"."OrderStatus" AS ENUM ('DRAFT', 'PENDING', 'PAID', 'CANCELED');
...
-- CreateIndex
CREATE UNIQUE INDEX "Variant_productId_size_scent_key" ON "public"."Variant"("productId", "size", "scent");
